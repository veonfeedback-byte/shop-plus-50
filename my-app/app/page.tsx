                  ...
                  return (
                    <div
                      ...
                      className={`flex-shrink-0 w-full h-[120px] sm:h-[140px] md:h-[160px] flex items-center justify-center
                        ${
                          realIndex === 0
                            ? "bg-gradient-to-r from-amber-200 via-rose-200 to-orange-100"
                            : ""
                        }
                        ${
                          realIndex === 1
                            ? "bg-gradient-to-r from-yellow-200 via-amber-200 to-orange-100"
                            : ""
                        }
                        ${
                          realIndex === 2
                        ...
                        ${
                          realIndex === 3
                            ? "bg-gradient-to-r from-rose-200 via-red-200 to-pink-100"
                            : ""
                        }
                        ${
                          realIndex === 4
                            ? "bg-gradient-to-r from-emerald-200 via-green-200 to-teal-100"
                            : ""
                        }
                      `}
                    >
                      ...
                      <div className="flex items-center gap-4">
                        {item.icon === "truck" && (
                          <Truck className="w-12 h-12 text-rose-600 drop-shadow-md" />
                        )}
                        {item.icon === "tag" && (
                          <Tag className="w-12 h-12 text-amber-600 drop-shadow-md" />
                        )}
                        {item.icon === "shopping-bag" && (
                          <ShoppingBag className="w-12 h-12 text-indigo-600 drop-shadow-md" />
                        )}
                        {item.icon === "flame" && (
                          <Flame className="w-12 h-12 text-red-600 drop-shadow-md" />
                        )}
                        {item.icon === "credit-card" && (
                          <CreditCard className="w-12 h-12 text-green-600 drop-shadow-md" />
                        )}
