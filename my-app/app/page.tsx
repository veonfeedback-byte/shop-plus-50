    ...
    <HomeContext.Provider value={{ resetHome }}>
      ...
      <div className="pb-28 pt-[50px]">
        ...
        <div className="fixed top-[56px] left-0 right-0 z-30 bg-white py-3 px-3 shadow-sm border-b border-gray-200">
          <div className="w-full px-0 md:px-3 flex items-center gap-3 overflow-hidden">
            {showBackButton && (
              <button
                onClick={resetHome}
                aria-label="Back"
        ...
        {searchTriggered && (debouncedQuery || activeCategory || activeSubcategory) ? (
          <>
            ...
            <section>
            <div className="w-screen -ml-[calc((100vw-100%)/2)]sticky top-[120px] z-20 bg-white shadow-sm border-b border-gray-200">
