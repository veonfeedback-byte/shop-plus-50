            ...
            <div className="mt-4 overflow-x-auto scrollbar-hide">
              <div className="flex space-x-4 px-2 w-max">
                {cachedCategories.map((cat, idx) => {
                  ...
                  return (
                    <div key={cat.slug} className="flex flex-col items-center w-20">
                      {/* card with icon */}
                      <button
                        onClick={() => {
                      ...
                      {/* text below card */}
                      <span
                        className="mt-2 text-xs font-medium text-black text-center leading-tight w-full truncate"
                        title={cat.name} // tooltip shows full name
                      >
                        {cat.name}
                      </span>
                    </div>
